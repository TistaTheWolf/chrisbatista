...
function createContainer(options = {}) {
	...
	const Container = /* @__PURE__ */ import_react.forwardRef(function Container(inProps, ref) {
		...
		return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ContainerRoot, {
			as: component,
			ownerState,
			className: clsx(useUtilityClasses$1(ownerState, componentName).root, className),
			ref,
			...other
		});
	});
...
//#endregion
export { useEnhancedEffect as $, red as A, clsx as At, exactProp as B, easing as C, mergeBreakpointsInOrder as Ct, lightBlue as D, require_react_is$1 as Dt, green as E, deepmerge as Et, createCssVarsProvider as F, getContrastRatio as G, darken as H, InitColorSchemeScript as I, hslToRgb as J, getLuminance as K, ThemeProvider as L, grey as M, common as N, blue as O, capitalize_default as Ot, createContainer as P, clamp as Q, useId as R, duration as S, handleBreakpoints as St, createMixins as T, createBreakpoints as Tt, decomposeColor as U, alpha as V, emphasize as W, recomposeColor as X, lighten as Y, rgbToHex as Z, excludeVariablesFromRoot as _, _extends as _t, useDefaultProps as a, generateUtilityClass as at, getOverlayAlpha as b, getValue as bt, styled as c, useTheme$3 as ct, GlobalStyles as d, styled$2 as dt, useThemeProps as et, useTheme as f, css as ft, createThemeWithVars as g, StyleSheet as gt, createTheme as h, createCache as ht, svgIconClasses as i, generateUtilityClasses as it, purple as j, require_prop_types as jt, orange as k, composeClasses as kt, rootShouldForwardProp as l, createTheme$1 as lt, defaultTheme as m, CacheProvider as mt, SvgIcon as n, resolveProps as nt, memoTheme as o, ClassNameGenerator as ot, identifier_default as p, keyframes as pt, hexToRgb as q, getSvgIconUtilityClass as r, styled$1 as rt, globalCss as s, useTheme$2 as st, createSvgIcon as t, getThemeProps$1 as tt, slotShouldForwardProp as u, createSpacing as ut, shouldSkipGeneratingVar as v, styleFunctionSx_default as vt, createTypography as w, resolveBreakpointValues as wt, createTransitions as x, getPath as xt, createColorScheme as y, createUnarySpacing as yt, useRtl as z };

//# sourceMappingURL=createSvgIcon-D1hahyqb.js.map